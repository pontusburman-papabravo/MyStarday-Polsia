...
**Nästa årsgrupp:** spec **STÄNGD** — [kravställning rev. 3](nasta-arsgrupp-12-18-kravstallning.md) · [de-risk](nasta-arsgrupp-12-18-derisk.md) · [Mellan innehåll](nasta-arsgrupp-12-18-mellan-innehall.md) · [H1-audit](nasta-arsgrupp-12-18-h1-audit.md) · [Ung v1 build/release](nasta-arsgrupp-12-18-ung-v1-build-release.md) — förälderns roll när barnet är 9–18.
