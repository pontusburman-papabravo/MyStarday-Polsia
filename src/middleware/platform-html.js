...
const MAGIC_VERSION = '33'; // Bump when parent-magic-common / dashboard-magic CSS changes (native WebView cache bust)
...
function injectPlatformHtml(body, reqPath, req) {
  ...
  const bodyInject =
    ...
    '<script src="/js/member-avatar.js?v=' + RELEASE_TAG + '"><\/script>\n' +
