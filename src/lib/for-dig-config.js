...
const FOR_DIG_GOALS = [
  ...
  },
  {
    ...
    activityNames: ['Klä på sig', 'Borsta tänderna (morgon)', 'Äta frukost', 'Packa väska'],
    scheduleDays: [1, 2, 3, 4, 5],
    scheduleSection: 'dag',
    highlightActivities: ['Klä på sig', 'Borsta tänderna (morgon)', 'Packa väska'],
  },
  {
    slug: 'skolansvar',
    icon: '🎒',
    title: 'Skolansvar',
    headline: 'Få hela skoldagen att flyta',
    accentColor: '#16A34A',
    accentBg: '#DCFCE7',
  ...
  },
  {
    ...
    activityNames: ['Städa rummet', 'Duka av', 'Hämta post', 'Hjälpa till'],
    scheduleDays: [0, 1, 2, 3, 4, 5, 6],
    scheduleSection: 'dag',
    highlightActivities: ['Städa rummet', 'Duka av', 'Hjälpa till'],
  },
  {
    slug: 'motivation',
    icon: '✨',
    ...
    rewardNames: ['Extra saga vid läggdags', 'Glass', 'Välja film på filmkväll', 'Skärmtid'],
    highlightActivities: ['Extra saga vid läggdags', 'Glass', 'Välja film på filmkväll'],
  },
  {
    slug: 'skarmtid-avtal',
    icon: '📱',
    title: 'Skärmtid som rutin',
    headline: 'Få skärmtid att bli en tydlig rutin',
    accentColor: '#0F766E',
    accentBg: '#CCFBF1',
    tagline: 'Avtalad skärmtid efter läxan — inte tjat och inte veckopeng.',
    ageMin: 9,
    ageMax: 12,
    outcomes: [
      'Veta när läxan är först',
      'Ha en tydlig tid för skärm',
      'Slippa förhandla varje kväll',
      'Kunna ändra avtalet senare',
    ],
    starsHint: '10–20 stjärnor per vecka',
    rewardExamples: [
      { icon: '🎮', label: 'Avtalad skärmtid' },
      { icon: '🎧', label: 'Egen musik' },
      { icon: '🍕', label: 'Fredagsmys' },
    ],
    primaryAction: 'explore',
    activateLabel: 'Aktivera skärmtid som rutin',
    activityNames: ['Läxa', 'Ledig tid'],
    scheduleDays: [1, 2, 3, 4, 5],
    scheduleSection: 'dag',
    highlightActivities: ['Läxa', 'Ledig tid'],
  },
  {
    slug: 'fritid-traning',
    icon: '🏃',
    title: 'Träning och fritid',
    headline: 'Få träning och fritid in i dagen',
    accentColor: '#B45309',
    accentBg: '#FFEDD5',
    tagline: 'Träning och egen tid syns i dagen — inte bara skola.',
    ageMin: 9,
    ageMax: 12,
    outcomes: [
      'Se träningen i dagens plan',
      'Komma ihåg att packa till träning',
      'Ha tid som är hens',
      'Slippa att fritid glöms bort',
    ],
    starsHint: '10–20 stjärnor per vecka',
    rewardExamples: [
      { icon: '⚽', label: 'Välja träningssnack' },
      { icon: '🎬', label: 'Filmkväll' },
      { icon: '🎧', label: 'Egen tid' },
    ],
    primaryAction: 'explore',
    activateLabel: 'Aktivera träning och fritid',
    activityNames: ['Leka utomhus', 'Kvällsaktivitet'],
    scheduleDays: [1, 2, 3, 4, 5],
    scheduleSection: 'dag',
    highlightActivities: ['Leka utomhus', 'Kvällsaktivitet'],
  },
];
