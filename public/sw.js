...
const CACHE_NAME = 'stjarndag-v952'; // P1 empty row routes to PR C empty state when schedule row has zero items
...
// stjarndag-v952: P1 empty row → PR C empty state when weekly_schedule exists with zero items
