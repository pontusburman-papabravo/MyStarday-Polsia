...
// stjarndag-v887: Phase 1B custody hardening — propagate active custody_home_id
// stjarndag-v888: Phase 1C — retire legacy Weekly Schedule entry points (Fyll vecka, legacy Kopiera dag, Library demotion)
// stjarndag-v889: Phase 1C custody hardening — day-tab "+" and section "+ Aktivitet" now custody-safe
...
// stjarndag-v918: IE/FI launch-ready but closed — billing deadlock guard, landing market state
...
// stjarndag-v911: Register Apple tap — language/country denials are not Apple errors
// stjarndag-v910: E1+E3 Settings people/access routes to Familj, even on family load error
// stjarndag-v909: D2 Familj people/access honesty — primary-gated actions, scoped pedagogs
// stjarndag-v908: E2 Notiser — 7-day successful-push archive, not inbox
// stjarndag-v907: E1+E3 Settings people/access routes to Familj
// stjarndag-v906: D2 Familj — accessible children only, pending invites visible
// stjarndag-v905: C1 För Dig — child/install scope honesty, error ≠ empty
// stjarndag-v904: A4+D1 rewards hub nearest-reward visibility + library editor [] ≠ all
// stjarndag-v903: B1/B2 Hem — error≠empty + attention ladder
// stjarndag-v902: A1 Hem — hide legacy star chart on magic home; /home nav + local dates
// stjarndag-v901: A2 PIN out of URL — wizard reveal + sanitize return paths
// stjarndag-v900: Apple Review R3 — RegistrationCountryGate.allow fail-closed if CountryChoice missing
// stjarndag-v899: Apple Review R3 — hoist register t() so confirmed-country Apple tap reaches signIn
...
const CACHE_NAME = 'stjarndag-v943'; // Remove founder-member banner
...
// stjarndag-v861: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v862: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v863: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
...
// stjarndag-v868: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
...
//   WKWebView load still gets the icon from cache instead of nothing.
// stjarndag-v876: P1 UI polish — trofe icon: drop stale unversioned SW precache entry
//   (runtime always requests ?v=N; other hub icons are never precached individually,
//   this one-off entry was the actual mismatch) + HUB_ASSET_VERSION 3->4, MAGIC_VERSION 31->32.
...
// stjarndag-v875: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v878: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v881: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v882: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v883: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
...
// stjarndag-v931: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
// stjarndag-v932: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
...
// stjarndag-v942: App Review IAP settings paywall CTA for native_purchase_eligible
// stjarndag-v941: planner B2 section edit on-row
// stjarndag-v943: Fas 9 — Tailwind build pipeline (CDN → tailwind.build.css)
